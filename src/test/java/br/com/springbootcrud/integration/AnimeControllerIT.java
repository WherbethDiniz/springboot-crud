package br.com.springbootcrud.integration;
...
import br.com.springbootcrud.util.AnimePostRequestBodyCreator;
import br.com.springbootcrud.wrapper.PageableResponse;
...
class AnimeControllerIT {
    ...
    @Autowired
    CdProjektUserRepository cdProjektUserRepository;
    private static final CdProjektUser USER = CdProjektUser.builder()
            .name("Uncharted")
            .password("{bcrypt}$2a$10$uKEDTEbbAqt1CBKy6nWs6O.J0rqesIvwqRj7ak3wyWj8o2guTN4Ja")
            .username("Sam")
            .authorities("ROLE_USER")
            .build();

    private static final CdProjektUser ADMIN = CdProjektUser.builder()
    ...
    static class Config {
        ...
        public TestRestTemplate testRestTemplateRoleUserCreator(@Value("${local.server.port}") int port) {
            RestTemplateBuilder restTemplateBuilder = new RestTemplateBuilder()
                    ...
                    .basicAuthentication("Sam", "nathan");
        ...
        public TestRestTemplate testRestTemplateRoleAdminCreator(@Value("${local.server.port}") int port) {
            RestTemplateBuilder restTemplateBuilder = new RestTemplateBuilder()
                    .rootUri("http://localhost:" + port)
                    .basicAuthentication("Drake", "nathan");
            return new TestRestTemplate(restTemplateBuilder);
        }
    }
    ...
    void list_ReturnsListOfAnimesInsidePageObject_WhenSuccessful() {
        ...
        cdProjektUserRepository.save(USER);
    ...
    void delete_RemovesAnime_WhenSuccessful() {
        Anime savedAnime = animeRepository.save(AnimeCreator.createAnimeToBeSaved());
        cdProjektUserRepository.save(ADMIN);
